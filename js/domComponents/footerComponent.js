class Footer {
  ...
  buildLinksFooter() {
    ...
    <a id="footer-privacy" href="https://ec.europa.eu/info/legal-notice_${REF.language.toLowerCase()}" class="ecl-link ecl-link--standalone ecl-site-footer__link">
    ${languageNameSpace.labels["FOOTER_LEGAL"]}
    </a>
    </li>
    <li class="ecl-site-footer__list-item">
    <a id="footer-legal" href="https://ec.europa.eu/info/privacy-policy_${REF.language.toLowerCase()}" class="ecl-link ecl-link--standalone ecl-site-footer__link">
    ${languageNameSpace.labels["FOOTER_PRIVACY"]}
    </a>
    </li>
    <li class="ecl-site-footer__list-item">
      <a id="footer-cookies" href="https://ec.europa.eu/info/cookies_${REF.language.toLowerCase()}" class="ecl-link ecl-link--standalone ecl-site-footer__link">
      ${languageNameSpace.labels["FOOTER_COOKIES"]}
      </a>
    </li>
    <li class="ecl-site-footer__list-item">
        <a id="footer-access" href="https://ec.europa.eu/eurostat/web/main/help/accessibility" class="ecl-link ecl-link--standalone ecl-site-footer__link">
