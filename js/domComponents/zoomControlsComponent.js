class ZoomControls {
    constructor() {
      ...
      this.zoomInButton = this.createZoomButton('btn-zoom ecl-button ecl-button--primary', 'in', languageNameSpace.labels['ZOOM_IN'], '<i class="fas fa-plus" focusable="false"></i>');
      ...
      this.zoomOutButton = this.createZoomButton('btn-zoom ecl-button ecl-button--primary', 'out', languageNameSpace.labels['ZOOM_OUT'], '<i class="fas fa-minus" focusable="false"></i>');
